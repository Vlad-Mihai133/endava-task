...
namespace CarInsurance.Api.Migrations
{
    ...
    public partial class Init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "ProcessedPolicyExpirations",
                columns: table => new
                {
                    Id = table.Column<long>(type: "INTEGER", nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProcessedPolicyExpirations", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ProcessedPolicyExpirations_Policies_PolicyId",
                        column: x => x.PolicyId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProcessedPolicyExpirations_PolicyId",
                table: "ProcessedPolicyExpirations",
                column: "PolicyId");
        }
